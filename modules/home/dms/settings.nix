{
  ...
  wifiNetworkPins = {
    preferredWifi = [ "optimus5" "optimus24" ];
  };
  bluetoothDevicePins = {
    preferredDevice = [ "2C:BE:EE:72:BF:BC" "68:CA:C4:E3:A0:1B" ];
  };
  ...
  barConfigs = [
    {
      ...
      centerWidgets = [
        ...
        { id = "memUsage"; enabled = true; minimumWidth = true; showSwap = true; }
        { id = "clock"; enabled = true; }
        { id = "dankPomodoroTimer"; enabled = true; }
        { id = "weather"; enabled = true; }
      ];
      rightWidgets = [
        { id = "systemTray"; enabled = true; }
        { id = "flatpakUpdates"; enabled = true; }
