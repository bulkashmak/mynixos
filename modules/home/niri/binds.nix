...
{
  options.my.niri._kdl.binds = lib.mkOption {
    type = lib.types.lines;
    internal = true;
  };

  config.my.niri._kdl.binds = ''
    binds {
        ...
        Mod+P      hotkey-overlay-title="Run an Application: Bitwarden"         { spawn "flatpak" "run" "com.bitwarden.desktop"; }
